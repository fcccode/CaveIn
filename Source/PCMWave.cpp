/*
	...
	Description:
	Implementation of the PCMWave class that represents a sampled sound in PCM wave format.
...
void PCMWave::WriteWaveFile (ofstream *anOutfile)
{
	...
	fields[0] = 'FFIR';
	fields[1] = mSize + 44;		// buffer size + chunk header fields + fmt chunk data.
	fields[2] = 'EVAW';
